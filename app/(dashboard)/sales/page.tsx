          ...
          <div>
            ...
            <div className="space-y-2">
              <Autocomplete
                ...
                placeholder="اسم العميل (اكتب للبحث)"
        ...
        <div className="fixed inset-0 z-50 bg-black/60 backdrop-blur-sm flex items-center justify-center p-4">
          <div className="bg-white rounded-3xl max-w-md w-full p-6 shadow-2xl space-y-4 text-right">
            ...
            <div>
              ...
              <input type="text" value={cancelReason} onChange={(e) => setCancelReason(e.target.value)} placeholder="مثال: خطأ في إدخال الكمية" className="w-full border-2 border-slate-200 rounded-xl px-3 bg-slate-50 h-11 text-sm" />
            </div>
            <div className="flex gap-2">
