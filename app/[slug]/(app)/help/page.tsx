...
// ⚠️ تحذير: عند إضافة/تعديل ميزة → حدّث TourGuide أيضاً
...
export default function HelpPage() {
  ...
  const sections = [
    ...
    },
    {
      ...
      content: [
        { num: '1', title: 'الاسم التجاري', desc: 'يظهر في القائمة الجانبية وأعلى كل صفحة. غيّره من هنا ليصبح اسم نشاطك الحقيقي بدل "ثُلَاث".' },
    ...
    },
    {
      key: 'freeform',
      icon: Scissors,
      title: 'شروة حرة — مرونة كاملة في الإنتاج',
      color: 'emerald',
      settingsLink: null,
      content: [
        { num: '1', title: 'متى تستخدمها', desc: 'عندما لا تريد التقيد بأصناف مسار ثابت، أو تريد تسجيل أصناف غير نمطية لشروة معينة.' },
        { num: '2', title: 'كل الأصناف متاحة', desc: 'افتراضياً، الصفحة تفتح على "شروة حرة" — 11 صنفاً كاملاً. أدخل أوزاناً فقط للأصناف التي أنتجتها فعلاً، واترك الباقي فارغاً.' },
        { num: '3', title: 'حفظ كقالب جديد', desc: 'بعد إدخال الأوزان (صنف واحد على الأقل بقيمة > 0)، اضغط الزر الأخضر "حفظ هذه الأصناف كمسار جديد". القالب يُنشأ بالأصناف المُنتَجة فقط، بنسبها من الوزن القايم.' },
        { num: '4', title: 'إضافة صنف مباشر', desc: 'زر "صنف جديد" أعلى بطاقة مخرجات التقطيع. يفتح نموذج إضافة صنف كامل (اسم، تسعير، معامل). يُضاف لـ inventory مباشرة ويظهر في القائمة فوراً.' },
        { num: '5', title: 'استخدام مسار جاهز', desc: 'بدلاً من "شروة حرة"، اختر مساراً معروفاً (مسار التجزئة، شاورما صدور، شاورما كاملة، صندوق كامل) — يظهر بأصنافه فقط مع النسب المتوقعة تلقائياً.' },
      ],
    },
    {
      key: 'opening',
