...
export default function TourGuide() {
  ...
  const slides = [
    { icon: LayoutDashboard, title: 'مرحباً بك في منظومة إدارة الدواجن', text: 'هذه جولة سريعة تشرح أقسام النظام ومتى تستخدم كل واحد. تستغرق دقيقة واحدة. يمكنك تخطيها في أي وقت والعودة إليها لاحقاً من الإعدادات.' },
